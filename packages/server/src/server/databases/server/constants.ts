...
export const DEFAULT_DB_ITEMS: { [key: string]: () => any } = {
    ...
    slack_webhook_url: () => "",
    slack_channel: () => "",
    slack_alert_no_receive_minutes: () => 10,
    slack_alert_no_send_minutes: () => 10,
    slack_activity_drop_percent: () => 50,
    slack_daily_report_hour: () => 9,
    slack_daily_report_timezone: () => "America/New_York",
    slack_alert_custom_message: () => "",
    slack_alert_message_filter: () => "all",
};
